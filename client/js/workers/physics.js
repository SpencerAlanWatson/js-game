...
define(['vendor/lodash', 'EventDispatcher' ], function (lodash, EventDispatcher) {
    ...
    function Physics() {
        ...
        physics.tick = function (nextFrame, timestamp) {
            ...
            /*lodash.each(physics.objects, function (firstObj, index, list) {
                lodash.each(list, function (secondObj, index2, list2) {
                    ...
                    if (Math.sqrt(distanceSqrd) < firstObj.radius + secondObj.radius) {
                        console.log(firstObj.tag + '
            collides with ' + secondObj.tag);
            ...
            //lodash.invoke(physics.objects, 'physicsTick ', perSecond);
