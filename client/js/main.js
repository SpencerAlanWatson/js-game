 ...
 (function (global, undefined) {
     ...
     require(["vendor/bootstrap", "vendor/angular", "state", "manager", "player", "controls", "shared-worker-util"], StartUp)

     function StartUp(bootstrap, angular,  state, Manager, Player, Controls, sharedWorker) {
